...
Before you start this tutorial, you should have [Python](https://www.python.org/) (with [pip](https://pypi.org/project/pip/)) installed on your development machine.
...
> [!NOTE]
> This tutorial was written with Python version 3.9.2 and Django version 3.2. The steps in this guide may work with other versions, but that has not been tested.
